...
//           <h2>Welcome Back</h2>
//           <p>Sign in to continue to PrepAI</p>
//         </div>
...
//               <button type="button" className="btn-text" onClick={handleResendOtp}>Resend OTP</button>
//             </div>
//           )}
//         </form>
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setError(""); setShowResend(false); setLoading(true);
